      ...
      <div className="travel-div">
        ...
        <section className="container wrapper-md">
          ...
          <section className="flex gap-3 md:gap-5 items-center flex-wrap">
            {mounted && SyncfusionComponents ? (
              <SyncfusionComponents.ChipListComponent id="travel-chip">
                <SyncfusionComponents.ChipsDirective>
                  {pillItems.map((pill, i) => (
                    <SyncfusionComponents.ChipDirective
                      key={i}
              ...
              </SyncfusionComponents.ChipListComponent>
            ) : (
              <div className="flex gap-3">
                {pillItems.map((pill, i) => (
                  <span
                    key={i}
                    className={`${pill.bg} text-base font-medium px-4 py-1 rounded-full`}
                  >
          ...
          <a href={paymentLink} className="flex">
            {mounted && SyncfusionComponents ? (
              ...
              <button
                className="button-class flex items-center justify-center gap-2"
                type="submit"
              >
                <span className="p-16-semibold text-white">
                  Pay to join the trip
